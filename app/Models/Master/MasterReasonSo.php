...
class MasterReasonSo extends Model
{
    use HasFactory;
    // use SoftDeletes;

    protected $table = 'm_reason_so';
    protected $primaryKey = 'reason_so_id';
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            ...
            $model->reason_so_id = $maxReasonSoId ? $maxReasonSoId + 1 : 1; // Set reason_so_id, mulai dari 1 jika tidak ada
        });
