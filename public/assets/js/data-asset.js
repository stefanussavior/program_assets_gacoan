    ...
    function generateRandomCode(length) {
      ...
      var table = $('#coba').DataTable({
        ...
        "columns": [
            ...
            {
                // Use asset_image_path instead of asset_image
                "data": "asset_image_path",
                "render": function(data, type, row) {
                    if (data) {
                        return `<img src="${data}" alt="Image Upload" style="width: 150px; height: 150px;">`;
                    } else {
                        return 'Tidak ada data image';
                    }
                }
            },
            {"data": "asset_code"},
        ...
        if (isValid) {
          ...
          Swal.fire({
            ...
            if (result.isConfirmed) {
              ...
              $.ajax({
                url: '/admin/add_data_asset', // Adjust your URL accordingly
                type: 'POST',
                data: formData,
