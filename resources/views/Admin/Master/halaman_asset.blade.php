        ...
        <form id="addAssetForm" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <input type="number" name="asset_quantity" id="add_asset_quantity" class="form-control" placeholder="Enter Asset Quantity" required min="1" step="1">
            </div>
            <div class="col-sm-6">
          ...
          <br>
          <label for="Asset Image">Upload Image/Gambar : </label>
