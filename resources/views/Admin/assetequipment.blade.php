                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive product-table" style="max-width: 100%; overflow-x: auto;">
                                ...
                                <table class="table table-striped display" id="coba" style="width: 100%;">
                                    ...
                                    <tbody>
                                        @foreach($assets_equipment as $asseteqp)
                                            <tr>
                                                <td>{{ $asseteqp->asset_code }}</td>
                                                <td>{{ $asseteqp->asset_model }}</td>
                                                <td>{{ $asseteqp->asset_status }}</td>
                                                <td>{{ $asseteqp->asset_quantity }}</td>
                                                <td>
                                                    @if($asseteqp->priority_name == 'Priority')
                                                        <span class="badge badge-danger text-white">{{ $asseteqp->priority_name }}</span> <!-- Priority: Red label -->
                                                    @elseif($asseteqp->priority_name == 'Basic')
                                                        <span class="badge badge-success text-white">{{ $asseteqp->priority_name }}</span> <!-- Basic: Green label -->
                                                    @elseif($asseteqp->priority_name == 'Not Priority')
                                                        <span class="badge badge-warning text-white">{{ $asseteqp->priority_name }}</span> <!-- Not Priority: Yellow label -->
                                                    @else
                                ...
                                <div class="d-flex justify-content-center align-items-center mt-4">
                                  <div>
                                      <!-- Previous Button -->
                                      @if ($assets_equipment->onFirstPage())
                                          <span class="disabled"><< Previous</span>
                                      @else
                                          <a href="{{ $assets_equipment->previousPageUrl() }}" class="btn btn-link"><< Previous</a>
                                      @endif
                                  </div>
                                  <div>
                                      <!-- Next Button -->
                                      @if ($assets_equipment->hasMorePages())
                                          <a href="{{ $assets_equipment->nextPageUrl() }}" class="btn btn-link">Next >></a>
                                      @else
                              ...
                              <div class="d-flex justify-content-center mt-2">
                                  <span>Page {{ $assets_equipment->currentPage() }} of {{ $assets_equipment->lastPage() }}</span>
                              </div>
                            </div>
                        </div>
                    </div>
