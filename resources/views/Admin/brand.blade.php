  ...
  <body>
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Brand Name List</h3>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">ASMI</li>
                    <li class="breadcrumb-item active">Brand Name List</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="modal fade" id="addDataBrand" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                        <div class="modal-dialog modal-md">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="saveBrandButton">Save changes</button>
                            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive product-table" style="max-width: 100%; overflow-x: auto; padding: 10px;">
                        <div class="d-flex justify-content-between mb-3 mt-3">
                            <h5>Brand Data</h5> <!-- Add a heading for the table if needed -->
                        ...
                        <table class="table table-striped display" id="coba" style="width: 100%; table-layout: fixed;">
                            <thead>
                                <tr>
                                    <th style="width: 70%;">Nama Brand</th>
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                            <div>
                                ...
                                @else
                                    <a href="{{ $brands->previousPageUrl() }}" class="btn btn-link"><< Previous</a>
                                @endif
                            </div>
                            <div>
                                @if ($brands->hasMorePages())
                                    <a href="{{ $brands->nextPageUrl() }}" class="btn btn-link">Next >></a>
                                @else
    ...
    <script>
        $(document).ready(function() {
            // Mengambil data brand menggunakan Ajax
            $.ajax({
                url: "{{ route('get.brand') }}", // Route untuk get_brand
                method: "GET",
                success: function(data) {
                    ...
                    data.forEach(function(brand) {
                        rows += `
                            <tr>
                                <td>${brand.brand_id}</td> <!-- Tampilkan ID Brand -->
                                <td>${brand.brand_name}</td> <!-- Tampilkan Nama Brand -->
                                <td>
                                <a href="javascript:void(0);" class="edit-button" data-id="${brand.brand_id}" data-name="${brand.brand_name}" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                    ...
                    $('#brandTableBody').html(rows); // Memasukkan baris ke dalam tbody
                },
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#saveBrandButton').click(function (e) {
                e.preventDefault();
                ...
                success: function(response) {
                    ...
                    error: function(jqXHR) {
                        const message = jqXHR.responseJSON?.message || 'Failed to update Brand.';
    ...
    <script>
        ...
        if (confirm('Apakah Anda yakin ingin menghapus Brand ini?')) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        window.location.href = response.redirect_url; // Redirect ke Admin.brand
                    } else {
