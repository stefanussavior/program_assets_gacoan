  ...
  <body>
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Category Name List</h3>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">ASMI</li>
                    <li class="breadcrumb-item active">Category Name List</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    ...
                    <div class="modal fade" id="addDataCategory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                        <div class="modal-dialog modal-md">
                            ...
                            <div class="modal-body">
                                <form id="addCategoryForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="text" name="cat_code" id="cat_code" class="form-control" placeholder="Enter Category Code" required>
                                        </div>
                                        <div class="col-sm-12">
                          ...
                          <div class="modal fade" id="categoryDetailModal" tabindex="-1" role="dialog" aria-labelledby="brandModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="brandModalLabel">Detail Kategori</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                      <p><strong>ID:</strong> <span id="cat-id"></span></p>
                                      <p><strong>Code:</strong> <span id="cat-code"></span></p>
                                      <p><strong>Name:</strong> <span id="cat-name"></span></p>
    ...
    <script>
        $(document).ready(function() {
            // Mengambil data Category menggunakan Ajax
            $.ajax({
                url: "{{ route('get.category') }}", // Route untuk get_Category
                method: "GET",
                success: function(data) {
                    ...
                    data.forEach(function(category) {
                        rows += `
                            <tr>
                                <td>${category.cat_id}</td> <!-- Tampilkan ID category -->
                                <td>${category.cat_code}</td> <!-- Tampilkan Nama category -->
                                <td>${category.cat_name}</td> <!-- Tampilkan Nama category -->
                                <td>
                                <a href="javascript:void(0);" class="edit-button" data-id="${category.cat_id}" data-name="${category.cat_name}" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                    ...
                    $('#categoryTableBody').html(rows); // Memasukkan baris ke dalam tbody
                },
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/admin/categorys/edit/' + $('#cat_id').val(),
    ...
    <script>
        ...
        if (confirm('Apakah Anda yakin ingin menghapus Category ini?')) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        window.location.href = response.redirect_url; // Redirect ke Admin.Category
                    } else {
