                          ...
                          <table class="table table-bordered table-striped" id="coba" width="100%">
                              <thead class="thead-dark">
                                  <tr>
                                      ...
                                      <th>Group User Roles</th>
                                      <th>Action</th>
                                  </tr>
                              </thead>
                              <tbody id="groupuserTableBody">
    ...
    <script>
        $(document).ready(function () {
            $('#saveGroupUserButton').click(function (e) {
                ...
                if (groupuserName === '') {
                    alert('GroupUser Name is required');
                    return;
                }
                if (groupuserRoles === '') {
                    alert('GroupUser Roles is required');
                    return;
                }

                // Kirimkan data menggunakan Ajax
                $.ajax({
                    url: '/admin/groupusers/edit/' + $('#group_id').val(), // Pastikan ini adalah URL yang benar
