  ...
  <body>
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>Location Name List</h3>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">ASMI</li>
                    <li class="breadcrumb-item active">Location Name List</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
					...
					<div class="card-body"> 
						<div class="btn-showcase">
                            <div class="button_between">
                                <button class="btn btn-square btn-primary" type="button" data-toggle="modal" data-target="#addDataLocation">+ Add Data Location</button>
                    ...
                    <div class="modal fade" id="addDataLocation" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                        <div class="modal-dialog modal-md">
                            ...
                            <div class="modal-body">
                                <form id="addLocationForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="text" name="loc_city" id="loc_city" class="form-control" placeholder="Enter Location City" required>
                                        </div>
                                        <div class="col-sm-12">
                                        <label for="loc_address">Location Address : </label>
                                        <input type="text" name="loc_address" id="loc_address" class="form-control" placeholder="Enter Location Address" required>
                                        </div>
                                        <div class="col-sm-12">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="saveLocationButton">Save changes</button>
                            </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            // Mengambil data Location menggunakan Ajax
            $.ajax({
                url: "{{ route('get.location') }}", // Route untuk get_location
                method: "GET",
                success: function(data) {
                    ...
                    $('#locationTableBody').html(rows); // Memasukkan baris ke dalam tbody
                },
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/admin/locations/edit/' + $('#loc_id').val(),
    ...
    <script>
        ...
        if (confirm('Apakah Anda yakin ingin menghapus Location ini?')) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        window.location.href = response.redirect_url; // Redirect ke Admin.Location
                    } else {
