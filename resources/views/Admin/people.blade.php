  ...
  <body>
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3>People Name List</h3>
                </div>
                <div class="col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">ASMI</li>
                    <li class="breadcrumb-item active">People Name List</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
					...
					<div class="card-body"> 
						<div class="btn-showcase">
                            <div class="button_between">
                                <button class="btn btn-square btn-primary" type="button" data-toggle="modal" data-target="#addDataPeople">+ Add Data People</button>
                    ...
                    <div class="modal fade" id="addDataPeople" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                        <div class="modal-dialog modal-md">
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Add Data People</h5>
                            ...
                            <div class="modal-body">
                                <form id="addPeopleForm" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="text" name="people_nickname" id="people_nickname" class="form-control" placeholder="Enter People Nickname" required>
                                        </div>
                                        <div class="col-sm-12">
                                        <label for="people_fullname">People Fullname : </label>
                                        <input type="text" name="people_fullname" id="people_fullname" class="form-control" placeholder="Enter People Fullname" required>
                                        </div>
                                        <div class="col-sm-12">
                                        <label for="people_email">People Email : </label>
                                        <input type="text" name="people_email" id="people_email" class="form-control" placeholder="Enter People Email" required>
                                        </div>
                                        <div class="col-sm-12">
                                        <label for="people_whatsapp">People Whatsapp : </label>
                                        <input type="text" name="people_whatsapp" id="people_whatsapp" class="form-control" placeholder="Enter People Whatsapp" required>
                                        </div>
                                        <div class="col-sm-12">
                                        <label for="division_id">Division Id : </label>
                                        <input type="text" name="division_id" id="division_id" class="form-control" placeholder="Enter People Division Id" required>
                                        </div>
                                        <div class="col-sm-12">
                                        <label for="dept_id">Departement Id : </label>
                                        <input type="text" name="dept_id" id="dept_id" class="form-control" placeholder="Enter People Departement Id" required>
                                        </div>
                                        <div class="col-sm-12">
                                        <label for="joblevel_id">Job Level Id : </label>
                                        <input type="text" name="joblevel_id" id="joblevel_id" class="form-control" placeholder="Enter People Level Id" required>
                                        </div>
                                        <div class="col-sm-12">
                                        <label for="region_id">Region Id : </label>
                                        <input type="text" name="region_id" id="region_id" class="form-control" placeholder="Enter People Region Id" required>
                                        </div>
                                        <div class="col-sm-12">
                                        <label for="loc_id">Location Id : </label>
                                        <input type="text" name="loc_id" id="loc_id" class="form-control" placeholder="Enter People Location Id" required>
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="savePeopleButton">Save changes</button>
                            </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div id="updateModal" class="modal fade" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              <div class="modal-dialog modal-md">
                                  <div class="modal-content">
                                      <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLabel">Update People</h5>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                              <span aria-hidden="true">&times;</span>
                                          </button>
                                      </div>
                    ...
                    <div class="card-body">
                      <div class="table-responsive product-table" style="max-width: 100%; overflow-x: auto;">
                        <div class="d-flex justify-content-between mb-3 mt-3">
                            <h5>People Data</h5> <!-- Add a heading for the table if needed -->
                        ...
                        <table class="table table-striped display" id="coba" style="width: 100%;">
                            ...
                            <tbody>
                                @foreach($peoples as $people)
                                    <tr class="text-center">
                                        <td>{{ $people->people_nickname }}</td>
                                        <td>{{ $people->people_fullname }}</td>
                                        <td>{{ $people->people_email }}</td>
                                        <td>{{ $people->people_whatsapp }}</td>
                                        <td>{{ $people->division_id }}</td>
                                        <td>{{ $people->dept_id }}</td>
                                        <td>{{ $people->joblevel_id }}</td>
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                          <div>
                              <!-- Previous Button -->
                              @if ($peoples->onFirstPage())
                                  <span class="disabled"><< Previous</span>
                              @else
                                  <a href="{{ $peoples->previousPageUrl() }}" class="btn btn-link"><< Previous</a>
                              @endif
                          </div>
                          <div>
                              <!-- Next Button -->
                              @if ($peoples->hasMorePages())
                                  <a href="{{ $peoples->nextPageUrl() }}" class="btn btn-link">Next >></a>
                              @else
                        ...
                        <div class="d-flex justify-content-center mt-2">
                            <span>Page {{ $peoples->currentPage() }} of {{ $peoples->lastPage() }}</span>
                        </div>
                      </div>
                  </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            // Mengambil data people menggunakan Ajax
            $.ajax({
                url: "{{ route('get.people') }}", // Route untuk get_people
                method: "GET",
                success: function(data) {
                    ...
                    data.forEach(function(people) {
                        rows += `
                            <tr>
                                <td>${people.people_id}</td> <!-- Tampilkan ID people -->
                                <td>${people.people_nickname}</td> <!-- Tampilkan Nama people -->
                                <td>${people.people_fullname}</td> <!-- Tampilkan Nama people -->
                                <td>${people.people_email}</td> <!-- Tampilkan Nama people -->
                                <td>${people.people_whatsapp}</td> <!-- Tampilkan Nama people -->
                                <td>${people.division_id}</td> <!-- Tampilkan Nama people -->
                                <td>${people.dept_id}</td> <!-- Tampilkan Nama people -->
                                <td>${people.joblevel_id}</td> <!-- Tampilkan Nama people -->
                                <td>${people.region_id}</td> <!-- Tampilkan Nama people -->
                                <td>${people.loc_id}</td> <!-- Tampilkan Nama people -->
                                <td>
                                <a href="javascript:void(0);" class="edit-button" data-id="${people.people_id}" data-name="${people.people_nickname}" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                    ...
                    $('#peopleTableBody').html(rows); // Memasukkan baris ke dalam tbody
                },
    ...
    <script>
        ...
        $.ajaxSetup({
            ...
            $('#savePeopleButton').click(function (e) {
                e.preventDefault();

                // Ambil data form
                var peopleNickname = $('#people_nickname').val();
                var peopleFullname = $('#people_fullname').val();
                var peopleEmail = $('#people_email').val();
                var peopleWhatsapp = $('#people_whatsapp').val();
                var divisionId = $('#division_id').val();
                var deptId = $('#dept_id').val();
                var joblevelId = $('#joblevel_id').val();
                var regionId = $('#region_id').val();
                var locId = $('#loc_id').val();

                // Kirimkan data menggunakan Ajax
                $.ajax({
                    url: '/add-people' + $('#people_id').val(), // Pastikan ini adalah URL yang benar
                    method: 'POST', // Pastikan ini menggunakan metode PUT
                    data: {
                    people_nickname: peopleNickname,
                    people_fullname: peopleFullname,
                    people_email: peopleEmail,
                    people_whatsapp: peopleWhatsapp,
                ...
                success: function(response) {
                    ...
                    error: function(jqXHR) {
                        const message = jqXHR.responseJSON?.message || 'Failed to update People.';
    ...
    <script>
        ...
        $('#updateForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '/admin/peoples/edit/' + $('#people_id').val(),
    ...
    <script>
        ...
        if (confirm('Apakah Anda yakin ingin menghapus People ini?')) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        window.location.href = response.redirect_url; // Redirect ke Admin.People
                    } else {
