                          ...
                          <table class="table table-bordered table-striped" id="coba" width="100%">
                              <thead class="thead-dark">
                                  <tr>
                                      ...
                                      <th>People Email</th>
                                      <th>People Whatsapp</th>
                                      <th>People Division Id</th>
                                      <th>People Departement Id</th>
                                      <th>People Job Level Id</th>
                                      <th>People Region Id</th>
                                      <th>People Location Id</th>
                                      <th>Action</th>
                                  </tr>
                              </thead>
    ...
    <script>
        $(document).ready(function () {
            $('#savePeopleButton').click(function (e) {
                ...
                if (peopleNickname === '') {
                    alert('People Name is required');
                    return;
                }

                // Kirimkan data menggunakan Ajax
                $.ajax({
                    url: '/admin/peoples/edit/' + $('#people_id').val(), // Pastikan ini adalah URL yang benar
