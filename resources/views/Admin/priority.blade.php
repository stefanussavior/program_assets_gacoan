                                ...
                                @foreach($prioritys as $priority)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            <a href="javascript:void(0);" class="edit-button" data-id="{{ $priority->priority_id }}" data-name="{{ $priority->priority_code }}" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="javascript:void(0);" class="detail-button" data-id="{{ $priority->priority_id }}" data-name="{{ $priority->priority_code }}" title="Detail">
