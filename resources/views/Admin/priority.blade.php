                  ...
                  <div class="card-header pb-0">
                    ...
                    <div class="modal fade" id="addDataPriority" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
                        <div class="modal-dialog modal-md">
                          ...
                          <div class="modal fade" id="priorityDetailModal" tabindex="-1" role="dialog" aria-labelledby="brandModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="brandModalLabel">Detail Priority</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                      <p><strong>ID:</strong> <span id="priority-id"></span></p>
                                      <p><strong>Kode:</strong> <span id="priority-code"></span></p>
                                      <p><strong>Name:</strong> <span id="priority-name"></span></p>
                    ...
                    <div class="card-body">
                      <div class="table-responsive product-table" style="max-width: 100%; overflow-x: auto;">
                        <div class="d-flex justify-content-between mb-3 mt-3">
                            <h5>priority Data</h5> <!-- Add a heading for the table if needed -->
                                ...
                                @foreach($prioritys as $priority)
                                    <tr class="text-center">
                                        ...
                                        <td class="text-center">
                                            ...
                                            data-id="{{ $priority->priority_id }}" 
                                            data-name="{{ $priority->priority_name }}" 
                                            data-code="{{ $priority->priority_code }}" 
                                            title="Edit">
                        ...
                        <div class="d-flex justify-content-center align-items-center mt-4">
                          <div>
                              <!-- Previous Button -->
                              @if ($prioritys->onFirstPage())
                                  <span class="disabled"><< Previous</span>
                              @else
                                  <a href="{{ $prioritys->previousPageUrl() }}" class="btn btn-link"><< Previous</a>
                              @endif
                          </div>
                          <div>
                              <!-- Next Button -->
                              @if ($prioritys->hasMorePages())
                                  <a href="{{ $prioritys->nextPageUrl() }}" class="btn btn-link">Next >></a>
                              @else
                        ...
                        <div class="d-flex justify-content-center mt-2">
                            <span>Page {{ $prioritys->currentPage() }} of {{ $prioritys->lastPage() }}</span>
                        </div>
                      </div>
                  </div>
                </div>
    ...
    <script>
      $(document).ready(function() {
          ...
          $('.detail-button').on('click', function() {
              ...
              var priorityCode = $(this).data('code');
              var priorityName = $(this).data('name');
              
              // Set the data into the modal
              $('#priority-id').text(priorityId);
              $('#priority-code').text(priorityCode);
              $('#priority-name').text(priorityName);
              
              // Show the modal
              $('#priorityDetailModal').modal('show');
          });
      });
    </script>
